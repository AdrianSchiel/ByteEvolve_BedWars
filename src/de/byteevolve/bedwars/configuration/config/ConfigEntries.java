...
public enum ConfigEntries implements ConfigEntry {
    ...
    private ConfigEntries(ConfigSections section, String path, Object value, Object defaultValue, String desc) {
